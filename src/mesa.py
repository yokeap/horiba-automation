...
try:
    ...
    print("Warning: OpenCV (cv2, INFO) not installed. Image detection will use basic matching without confidence levels.", "INFO")
    print("To install: pip install opencv-python", "INFO")
